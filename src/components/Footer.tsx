      ...
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          <div className="lg:col-span-2 space-y-4">
            ...
            <p className="text-sm text-slate-400 leading-relaxed max-w-sm">
              滨州村庄名录与本地生活服务平台，记录乡土根脉，服务本地生活。
              致力于打造滨州最全面的村庄信息与本地服务门户。
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:13326280320" className="hover:text-amber-400">13326280320</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-amber-400" />
                <a href="mailto:admin@keyi.de5.net" className="hover:text-amber-400">admin@keyi.de5.net</a>
              </li>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-slate-500">
            运营主体：滨州索引工作室 · &copy; {new Date().getFullYear()} 滨州索引
          </p>
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-slate-500">
            <Link href="/credentials/" className="hover:text-slate-300 transition-colors">资质说明</Link>
